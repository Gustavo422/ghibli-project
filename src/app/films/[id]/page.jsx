        ...
        <div className="relative flex h-screen w-screen flex-row items-start justify-center">
          <div className="relative top-0">
            <div className="absolute h-screen w-screen">
              ...
              />
              <div className="z-1 absolute bottom-0 left-0 h-screen w-full bg-gradient-to-t from-slate-950 via-slate-950/90 to-slate-900/85" />
            </div>
          </div>
          <div className="z-10 mt-36 flex h-full w-full flex-col items-center justify-center md:mt-80 md:pt-10">
            <div className="flex h-screen w-screen flex-col lg:w-[80%] lg:flex-row">
              <div className="relative h-[450px] w-[300px] shrink-0 pl-3 lg:mr-10 lg:h-[384px] lg:w-[255px] lg:pl-0">
                <Image
                  width={300}
                  height={450}
                  style={{
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="pl-3 pr-3 md:mt-8 md:w-[800px] lg:pl-0 lg:pr-0">
                  <h2 className="mb-2 mt-4 text-lg font-semibold text-gray-200 sm:text-xl md:mb-4 md:text-2xl lg:mt-0">
                    Description:
                  </h2>
